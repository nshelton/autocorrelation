// PostProcessingUtils is re-exported from three/webgpu, not the main `three`
// entry. The upstream addon imports it from 'three' which fails to resolve
// against three.module.js. This local copy splits the import — only change
